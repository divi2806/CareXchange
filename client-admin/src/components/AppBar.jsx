                ...
                <Toolbar>
                    ...
                    >
                        <img
                            ...
                            alt="Your Logo"
                            style={{ height: 150, marginRight: "900px", cursor: "pointer" }}
                        ...
                        <Typography
                            ...
                            component="div"
                        >
                            {/* Keep this part empty, as the logo is displayed */}
                        </Typography>
                    </div>
                    {admin.isLoggedIn ? (
                        <div>
                ...
                <List>
                    <ListItem disablePadding>
                        <ListItemButton
                            onClick={() => {
                                handleDrawerClose();
                                navigate("/listMedicalItems");
                            }}
                        >
                            <ListItemIcon>
                                <ShoppingBasketIcon />
                            </ListItemIcon>
                            <ListItemText primary={"List Medical Items"} />
                        </ListItemButton>
                    </ListItem>
                </List>
            </Drawer>
